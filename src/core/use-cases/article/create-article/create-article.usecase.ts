...
export class CreateArticleUseCase {
     ...
     *
     * @remarks
     * Mentions are resolved and stored here but nobody is notified: an article
     * is born a draft, and a draft naming someone is not yet an event they
     * could act on. PublishArticleUseCase is what turns them into notifications.
     */
    async execute(input: CreateArticleUseCaseInput): Promise<Article> {
        ...
        const article = Article.create({
            ...
            mentions: await resolveMentions({
                content: body,
